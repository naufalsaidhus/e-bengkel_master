...
<body>
   ...
   <div class="table-users">
      ...
      <table cellspacing="0">
         ...
         ?>
            <td> <a href="<?= base_url(); ?>Kapbeng/ubah/<?= $user_data['id_alat']; ?>" class="badge badge-success">ubah</a>
               <a href="<?= base_url(); ?>Kapbeng/hapus/<?= $user_data['id_alat']; ?>" class="badge badge-danger" onclick="return confirm('yakin hapus?');">hapus</a>
            </td>
         <?php
            "</tr>";
         }
