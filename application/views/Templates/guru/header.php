    ...
    <div class="container-fluid d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="<?= base_url();  ?>Guru/index">Home</a></li>
          <li><a href="<?= base_url(); ?>Guru/data">Lihat Barang</a></li>
          <li><a href="<?= base_url(); ?>Guru/persetujuan">Persetujuan</a></li>
          <li><a href="<?= base_url(); ?>Guru/laporanl">Laporan</a></li>
