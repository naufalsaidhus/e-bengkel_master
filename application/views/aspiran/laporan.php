        ...
        <table cellspacing="0">
            ...
            ?>
                <?php if ($user_data['status_peminjaman'] == "Menunggu Persetujuan Dari Aspiran/Kapbeng") { ?>
                    <td>
                        <a href="<?= base_url(); ?>Aspiran/setuju/<?= $user_data['id_peminjaman']; ?>" class="badge badge-success" id="setuju" name="setuju">Setuju</a>
                        <a href="<?= base_url(); ?>Aspiran/tolak/<?= $user_data['id_peminjaman']; ?>" class="badge badge-danger" id="tolak" name="setuju">Tolak</a>
                    </td>
                <?php }
                if ($user_data['status_peminjaman'] == "Dipinjam") { ?>
                    <td>
                        <a href="<?= base_url(); ?>Aspiran/kembali/<?= $user_data['id_peminjaman']; ?>" class="badge badge-success" id="kembali" name="kembali">Dikembalikan</a>
                    </td>
                <?php } ?>
