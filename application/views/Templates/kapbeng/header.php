    ...
    <div class="container-fluid d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="<?= base_url();  ?>Kapbeng/index">Home</a></li>
          <li><a href="<?= base_url(); ?>Kapbeng/tambah">Tambah Barang</a></li>
          <li><a href="<?= base_url(); ?>Kapbeng/data">Lihat Barang</a></li>
          <li><a href="<?= base_url(); ?>Kapbeng/laporan">Persetujuan</a></li>
          <li><a href="<?= base_url(); ?>Kapbeng/riwayat">Laporan</a></li>
