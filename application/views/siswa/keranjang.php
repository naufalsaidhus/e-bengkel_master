        ...
        <table cellspacing="0">
            ...
            foreach ($hasil as $user_data) {
                ...
                if ($user_data['jenlat'] == "Tidak Sekali Pakai") {
                    echo "<td>" . $user_data['status_keranjang'] . "</td>";
                } else {
                    echo "<td>" . $user_data['jumlah_pinjam'] . "</td>";
                }

            ?>
                <td> <a href="<?= base_url(); ?>Siswa/batal/<?= $user_data['id_alat']; ?>" class="badge badge-danger">Batal</a>
                    <a href="<?= base_url(); ?>Siswa/kirim/<?= $user_data['id_alat']; ?>" class="badge badge-primary">Pinjam</a>
                </td>
            <?php
                "</tr>";
            }
