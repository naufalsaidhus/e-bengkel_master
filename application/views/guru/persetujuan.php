...
<body>
    ...
    <div class="table-users">
        ...
        <table cellspacing="0">
            ...
            ?>
                <?php if ($user_data['status_peminjaman'] == "Menunggu Persetujuan Guru") { ?>
                    <td>
                        <a href="<?= base_url(); ?>Guru/setuju/<?= $user_data['id_peminjaman']; ?>" class="badge badge-success" id="setuju" name="setuju">Setuju</a>
                        <a href="<?= base_url(); ?>Guru/tolak/<?= $user_data['id_peminjaman']; ?>" class="badge badge-danger" id="tolak" name="setuju">Tolak</a>
                    </td>
                <?php } ?>
